...
type WizardNotificationNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'WizardNotification'
>;

export function WizardNotificationScreen() {
  ...
  const handleEnableNotifications = async () => {
    ...
    try {
      ...
      setIsLoading(false);
      navigation.navigate('WizardCompletion');
    }
  };
  ...
  return (
    <View
      ...
      testID="wizard-notification-screen"
    >
